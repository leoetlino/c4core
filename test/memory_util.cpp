...
TEST(msb11, basic)
{
    EXPECT_EQ((msb11<int, 0>::value), -1);
    EXPECT_EQ((msb11<int, 1>::value),  0);
    EXPECT_EQ((msb11<int, 2>::value),  1);
    EXPECT_EQ((msb11<int, 3>::value),  1);
    EXPECT_EQ((msb11<int, 4>::value),  2);
    EXPECT_EQ((msb11<int, 5>::value),  2);
    EXPECT_EQ((msb11<int, 6>::value),  2);
    EXPECT_EQ((msb11<int, 7>::value),  2);
    EXPECT_EQ((msb11<int, 8>::value),  3);
    EXPECT_EQ((msb11<int, 9>::value),  3);
    EXPECT_EQ((msb11<int,10>::value),  3);
    EXPECT_EQ((msb11<int,11>::value),  3);
    EXPECT_EQ((msb11<int,12>::value),  3);
    EXPECT_EQ((msb11<int,13>::value),  3);
    EXPECT_EQ((msb11<int,14>::value),  3);
    EXPECT_EQ((msb11<int,15>::value),  3);
    EXPECT_EQ((msb11<int,16>::value),  4);
}
